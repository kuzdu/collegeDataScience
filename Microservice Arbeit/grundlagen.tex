...
%TODO: Das Wort Message Broker einführen
In dieser Abbildung haben Microservice B und C das Event x beim Ergeinisbus (Event Bus) abonniert (subscribed). D.h. Microservice A veröffentlicht (published) eine Änderung, woraufhin B und C informiert werden. B und C können nun ihren Datenbestand aktualisieren und halten die aktuelle Daten vor. Parallel kann der Microservice A seine Abfrage ganz normal weiterführen. Der Eventbus ist dementsprechend ein Vermittler, welcher garantiert, dass die Nachrichten früher oder später übertragen werden.\cite{cesardelatorre2018azure}\cite{wolff2018mic_praxis} \\
...
Drauf eingehen, noch keine Lösung. 
!!! -> wie wird garantiert, dass MessageQueue erreicht wird !!! \\
//was wenn RabbitMQ nicht erreichbar ist? 
// % TODO Robins Antwort abwarten
...
Aus den zwei vorherigen Abschnitten ergibt sich folgende Aufstellung.

%TODO: Longtable draus machen
\begin{table}
	\begin{center}
		\begin{tabular}{p{1,5cm}p{5cm}p{5cm}}
			...
			& 
				\begin{itemize}
					...
					\item Flexibilität, da Mehrfach-Empfang
...
% TODO Problematik mit der Konistenz auffassen: CAD Theorem
% Empfehlung von microservice in aciton und Wollf, dass man asynch wählen soll
% Hinweis, dass es auch Fälle gibt, wo sync ggf. notwendig ist

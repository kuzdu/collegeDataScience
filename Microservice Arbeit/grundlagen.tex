...
%Ziel: "DDD als sinnvolles Werkezeug, um Microservices fachlich einzuteilen."
...
%%% nicht sicher was mit REWE Digital hier gemacht wird 
...
%% Ziel: Bounded Context = Microservice
%% Es stellt sich die Frage, wie die Microservices aufgebaut sind, allgemein: Wie kommunzieren usw. Dann die 

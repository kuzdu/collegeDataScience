...
% TODO: Bild einfügen API Gateway 
% Weitere Features erwähnen siehe Google Docs
% Ggf. noch Nachteile erwähnen

%TODO: Kurzdefinition Service Mesh 
Die nächste Steigerung von ein API-Gateway wäre ein sogenannter Service Mesh. Ein Service Mesh ist... .... Da Service Meshes den Umfang dieser Arbeit übersteigen würden, wird darauf nicht weiter eingegangen (siehe Ausblick im Fazit). 

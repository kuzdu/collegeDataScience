...
Ebenfalls ist die Tabelle nicht vollständig: Nicht aufgeführt ist beispielsweise der Umgang mit Konfigurationsdateien, Monitoring oder Logging. Dies liegt unter anderem daran, weil es vom Einzelfall abhängt: Beim Monitoring kann zum Beispiel global entschieden werden, \textit{wo} Metriken abgelegt werden, aber jeder Service entscheidet selbst, \textit{was} dort abgelegt wird. 

%%% Hier noch die weiteren drei Punkte erwähnen. S. 28 

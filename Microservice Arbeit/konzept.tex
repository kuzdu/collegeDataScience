...
%Argumentationsstruktur folgen: https://medium.com/linagora-engineering/how-to-choose-a-message-queue-247dde46e66c
...
\textbf{Clouds}: Die Clouddienste Google, AWS und Azure bieten ebenfalls eigene Lösungen an. Auf diese wird allerdings nicht weiter eingegangen, da bei dem Gateway und dem Hosting bereits auf eine Cloudlösung verzichtet worden ist. \\

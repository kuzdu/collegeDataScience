...
Words-Domainmodel:
\begin{itemize}
	\item id: Dient als unique identifier 
	\item category\_name: Name der Kategorie
	\item subtitle: Beschreibung der Kategorie
	\item image\_name: Name des Bildes, welches für eine Kategorie hinterlegt werden soll
	\item premium\_key: Notwendig für die Kaufabwicklung zum Identifizieren, um welchen In-App-Kauf es sich handelt
	\item is\_premium: Markiert, ob eine Kategorie kostenpflichtig ist oder nicht
	\item selected: Definiert, ob die Kategorie in der App vorausgewählt ist oder nicht
	\item words: Die Begriffe pro Kategorie, welche erraten werden können
	\item sort: Definiert, an welcher Stelle in der Sortierung die Kategorie ist
	\item is\_activ: Definiert, ob die Kategorie in der App angezeigt wird oder nicht
	\item updated\_at: Zeitpunkt, wann die Kategorie das letzte mal verändert worden ist 
\end{itemize}

%TODO - morgen: Die restlichen Models ausdefinieren, ein Abschlusswort sagen und Docker rechtfertigen.

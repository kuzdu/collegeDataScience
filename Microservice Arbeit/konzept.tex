...
Es gibt zahlreiche Message Queues, die selbstbeschreibend schnell, robust, zuverlässig und einfach zu implementieren sind. Derzeitig verwendete Message Queues könnten sein: RabbitMQ, Kafka, RocketMQ, Artemis oder NSQ.\\

Bevor die Message Queues Im Detail gegeneinander abgewogen werden, wird untersucht, ob es bereits Ausschlusskriterien gibt. Zum Beispiel weist die RocketMQ (Apache Projekt) noch über 130 Github Issues auf, weshalb davon auszugehen ist, dass diese Message Queue noch in der Entwicklung steht. Artemis verwendet noch ältere Technologien wie XML und NSQ bietet nicht den Funktionsumfang wie andere Queues (z.B. Haltbarkeit der Nachrichten oder Clustering).\\ %verlinken auf medium artikel

%Abwägen zwischen RabbitMQ und Kafka
%https://medium.com/linagora-engineering/how-to-choose-a-message-queue-247dde46e66c

Einige der MessageQueues lassen sich aus unterschiedlichen Gründen ausschließen: RocketMQ 

...
Eine weitere Möglichkeit ist ein Gateway mit \textbf{Istio} in Kombination mit Kubernetes aufzubauen. Das hätte unter anderem den großen Vorteil, dass die Services sich untereinander kennen und die Kommunikation sehr wenig händische Konfigurationen benötigt. Allerdings erfordert Kubernetes sowie Istio jeweils ein hohes Maß an technischem Verständnis und ist nicht lohnenswert für eine Handvoll Services.\\    
% TODO Verlinken
%https://www.heise.de/developer/artikel/Istio-Das-Service-Mesh-fuer-verteilte-Systeme-4153426.html
%https://istio.io/docs/setup/kubernetes/install/kubernetes/

- Ocelot % Microsoft empfohlen.  (leichtgewichtig und open source (https://devblogs.microsoft.com/cesardelatorre/designing-and-implementing-api-gateways-with-ocelot-in-a-microservices-and-container-based-architecture/), empfohlen von Microsoft für .net)
...
Aufgrund der Rercheren wird sich für Ocelot entschieden.\\
